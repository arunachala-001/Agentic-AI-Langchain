"""Raw prompt data/constants used by the text_summarization package.

Keep large raw text out of `main.py` so the entrypoint remains clean and readable.
"""
...
JOB_SEARCH = """
search for 3 job postings for an AI engineer in the Chennai greater area on linkedin and list their details?
"""
